...
#Do we want to know how the sludge components change? Or do we just want the system LCA/cost/biogas production and fugu
    ...
    HCl_Tank = qsu.StorageTank('T100', ins='HCl', outs=('HCl_out'),
    ...
    NaOH_WS = su.preWSConverter('S100', ins='NaOH_assumed', outs=('NaOH_out'), init_with='WasteStream')
    NaOH_WS.ins[0].price = 0.517 #include source, lists price per kg of NaOH  
    NaOH_WS.register_alias('NaOH_WS')
    
    if HTLmodel == 'MCA':    
        HTL = qsu.HydrothermalLiquefactionMCA('A120', ins=(H1-0, NaOH_WS-0, 'PFAS_in', HCl_Tank-0), outs=('hydrochar','HTL_aqueous','biocrude','offgas_HTL'),
        ...
        HTL = qsu.HydrothermalLiquefactionKinetics('A120', ins=(H1-0, NaOH_WS-0, 'PFAS_in', HCl_Tank-0), outs=('hydrochar','HTL_aqueous','biocrude','offgas_HTL'),
...
#   H2SO4_Tank.register_alias('H2SO4_Tank')    
    ...
    # TODO: update the NaOH price here to be consistent with the NaOH in HTL
    ...
    # HTL_NaOH
    qs.StreamImpactItem(ID='NaOH_HTL_item',
                        linked_stream=stream.NaOH_assumed,
                        Acidification=0.33656,
                        Ecotoxicity=0.77272,
                        Eutrophication=0.00032908,
                        GlobalWarming=1.2514,
    ...
    # HTL_HCl
    qs.StreamImpactItem(ID='HCl_HTL_item',
                        linked_stream=stream.HCl,
                        Acidification=0.29714091,
                        Ecotoxicity=0.84142564,
                        Eutrophication=0.000223493,
                        GlobalWarming=0.87300274,
                        OzoneDepletion=3.47E-07,
                        PhotochemicalOxidation=0.002336711,
                        Carcinogenics=0.01270564,
                        NonCarcinogenics=15.248377,
                        RespiratoryEffects=0.001994018)  
